...
Profiles ship with curio for popular sites (arxiv, github, etc.) and users
can publish/share their own. The community registry will live at
``github.com/yourhandle/curio-profiles`` and ``curio profiles update``
pulls the latest.

Public API::

    from curio.profiles import get_profile, list_profiles, ProfileRegistry
