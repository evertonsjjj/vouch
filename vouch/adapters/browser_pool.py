...
Why this exists
---------------
The plain :class:`vouch.adapters.browser.BrowserAdapter` launches and tears
...
log = logging.getLogger("vouch.browser_pool")
...
class BrowserPool:
    ...
    Construct one per :class:`vouch.engine.SearchEngine`. Call
