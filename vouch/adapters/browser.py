...
log = logging.getLogger("vouch.adapter.browser")
...
_MAX_PARALLEL_BROWSERS = int(os.environ.get("VOUCH_MAX_BROWSERS", "1"))
    ...
    def __init__(
        ...
        *,
        ...
        if not _PLAYWRIGHT_AVAILABLE:
            raise ImportError(
                "BrowserAdapter requires playwright. Install with: pip install 'vouch[browser]' "
                "and run: vouch install-browser"
            )
