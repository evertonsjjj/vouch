...
log = logging.getLogger("vouch.profiles")
...
class ProfileRegistry:
    ...
    def builtin(cls) -> ProfileRegistry:
        ...
        # Merge profile plugins installed via pip (entry_point: vouch.profiles).
        try:
        ...
        # Merge the community registry cached by ``vouch profiles update``.
        try:
