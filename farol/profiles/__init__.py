...
Profiles ship with farol for popular sites (arxiv, github, etc.) and users
can publish/share their own. The community registry will live at
``github.com/yourhandle/farol-profiles`` and ``farol profiles update``
pulls the latest.

Public API::

    from farol.profiles import get_profile, list_profiles, ProfileRegistry
