"""CrewAI tool wrapper around farol's SearchEngine."""
...
try:
    ...
    try:
        ...
        raise ImportError("CrewAI integration requires crewai. pip install 'farol[crewai]'") from e
